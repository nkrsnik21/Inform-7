...
Will Max's instincts guide him back to the one person who means the world to him? The journey begins now."; now the time of day is 5:34 pm; now the left hand status line is  "Time: [time of day] 11th January"; now the printed name of House key is "Unknown Item"; now the description of House key is "What is this thing?";
